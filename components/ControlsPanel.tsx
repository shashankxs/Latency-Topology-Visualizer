...
// ControlsPanel.tsx — with CSV and PNG export features
    ...
    <div>
      ...
      <div style={{ marginTop: 12 }}>
        ...
        <div style={{ marginTop: 12 }}>
          ...
          <div role="list" aria-label="Exchange list" style={{ display: "grid", gap: 6, marginTop: 6 }}>
            {visibleExchanges.map((s) => {
              ...
              const msText = ms === undefined ? "—" : `${ms} ms`;
              const pillColor =
                ms === undefined
                ...
                >
                  <div>
                    <div style={{ fontSize: 14 }}>
                      {s.name} <small style={{ opacity: 0.7 }}>{s.city ? `— ${s.city}` : ""}</small>
                    </div>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          >
            {loadingHistory ? (
              <div style={{ fontSize: 12, opacity: 0.8 }}>Loading historical data…</div>
