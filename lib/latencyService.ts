/**
 * Mock latency service for demo purposes
 * - Emits a "current" latency matrix at an interval (default 5s).
 * - Stores simple historical time series per pair for charting.
 *
...
class MockLatencyService {
  ...
  private baseDistance(a: any, b: any) {
  ...
  private randomLatency(a: any, b: any) {
